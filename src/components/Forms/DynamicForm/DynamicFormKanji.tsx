...
export const DynamicFormKanji: React.FC<TDynamicFormKanjiProps> = ({
  isOpened,
  onClose,
  formName = '',
  onSubmit,
  ...
  const handleOnChange = (e: InputChangeEvent, index: number) => {
    const newWord = {
      id: onWords[index].id,
  ...
  const handleKunChange = (e: InputChangeEvent, index: number) => {
    const newWord = {
  ...
  const form = (
    ...
    >
      ...
      <NInputsBlock
        ...
        addLabel="Add"
        inputValues={onWords}
        inputInfos={onKunInputsInfo}
        onChange={handleOnChange}
        onRemoveClicked={handleRemoveOnWordClicked}
        onAddClicked={handleAddOnWordClicked}
      />
      {/*<Box>*/}
      {/*  <Typography*/}
      {/*    variant="subtitle1"*/}
      ...
      <Box>
        ...
        <Box sx={{ display: 'grid', gap: 3, mb: 4 }}>
          <Box sx={{ display: 'grid', gap: 2 }}>
            <NInputsList<OnKunWordInfo>
              inputValues={kunWords}
              inputInfos={onKunInputsInfo}
